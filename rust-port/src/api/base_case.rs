...
include!("base_case_impls/base_case_impl_pdf_html.rs");
include!("base_case_impls/base_case_impl_extra.rs");
...
include!("base_case_impls/base_case_impl_remaining.rs");
include!("base_case_impls/base_case_impl_remaining_links.rs");
include!("base_case_impls/base_case_impl_remaining_downloads.rs");
include!("base_case_impls/base_case_impl_remaining_storage.rs");
include!("base_case_impls/base_case_impl_remaining_dom.rs");
include!("base_case_impls/base_case_impl_remaining_window.rs");
include!("base_case_impls/base_case_impl_remaining_mouse.rs");
include!("base_case_impls/base_case_impl_remaining_alerts.rs");
include!("base_case_impls/base_case_impl_remaining_browser.rs");
include!("base_case_impls/base_case_impl_remaining_nav.rs");
include!("base_case_impls/base_case_impl_remaining_media.rs");
include!("base_case_impls/base_case_impl_remaining_tours.rs");
include!("base_case_impls/base_case_impl_remaining_charts.rs");
include!("base_case_impls/base_case_impl_remaining_presentations.rs");
include!("base_case_impls/base_case_impl_remaining_jslibs.rs");
include!("base_case_impls/base_case_impl_remaining_misc.rs");
